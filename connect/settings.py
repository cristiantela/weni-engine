...
env = environ.Env(
    ...
    PLAN_BASIC_LIMIT=(int, 100),
    PLAN_BASIC_PRICE=(int, 1000),
    PLAN_PLUS_LIMIT=(int, 200),
    PLAN_PLUS_PRICE=(int, 2000),
    PLAN_PREMIUM_LIMIT=(int, 300),
    PLAN_PREMIUM_PRICE=(int, 3000),
    PLAN_ENTERPRISE_LIMIT=(int, 400),
    PLAN_ENTERPRISE_PRICE=(int, 4000),
)
